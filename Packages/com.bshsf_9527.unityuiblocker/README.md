...
<root>
  ...
  ├── Editor
  │   ├── Bshsf9527.UnityUiBlocker.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Bshsf9527.UnityUiBlocker.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Bshsf9527.UnityUiBlocker.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Bshsf9527.UnityUiBlocker.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Bshsf9527.UnityUiBlocker`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Unity UI Blocker Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Bshsf9527.UnityUiBlocker.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Bshsf9527.UnityUiBlocker.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Bshsf9527.UnityUiBlocker.Editor.Tests.asmdef`

  `Tests/Runtime/Bshsf9527.UnityUiBlocker.Tests.asmdef`
